...
const ElementDisplay = ({
  ...
  return (
    <main class="h-[100vh] w-[100vw] justify-center dark:bg-gray-900">
      ...
      <div class="flex h-fit w-screen justify-center">
        <div
          class="flex h-[150px] w-[150px] cursor-default flex-col items-center justify-center rounded-xl border-none transition-all duration-200 ease-in-out"
      ...
      <div class="flex h-[50vh] w-screen justify-center">
        <div class="flex h-[50vh] w-[50vw] flex-col justify-center">
          <p class="m-4 pl-[12.5vw] font-inter text-[2rem] dark:text-gray-200">
...
const Home = ({
  ...
  return (
    <>
      <header class="mb-8 text-center font-poppins text-6xl dark:text-white">
        Element.al
      </header>
      <main>
        <KeySequence
        ...
        >
          <input
            class="h-[6vh] w-[30vw] rounded-md p-2 text-2xl"
            type="text"
            name="element"
          ...
          />
          <button
            class="ml-2 h-[6vh] w-20 rounded-md border-none bg-[#4020cf] text-2xl text-white hover:bg-[#2f13ac]"
            type="submit"
          >
            Go
          </button>
        </form>
        <p class="m-3.5 text-center text-xl dark:text-gray-200">
          You can search by name, atomic number or symbol.
        </p>
      </main>
      <footer class="flex flex-col items-center">
        <p class="mb-3.5 mt-8 text-center text-xl dark:text-gray-200">
          Created by
        </p>
